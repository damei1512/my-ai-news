    ...
    try:
        ...
        result = {
            ...
            "x_digest": {
                ...
                "stale": bool(x_digest_payload.get("stale")),
                "stale_reason": x_digest_payload.get("stale_reason", ""),
                "generated_at": x_digest_payload.get("generated_at", ""),
                "last_success_at": x_digest_payload.get("last_success_at", ""),
            },
